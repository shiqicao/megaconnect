...
type Event struct {
	...
	Context              map[string][]byte `protobuf:"bytes,3,rep,name=context,proto3" json:"context,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func init() {
	proto.RegisterType((*RegisterChainManagerRequest)(nil), "rpc.RegisterChainManagerRequest")
	proto.RegisterType((*RegisterChainManagerResponse)(nil), "rpc.RegisterChainManagerResponse")
	proto.RegisterType((*InstanceId)(nil), "rpc.InstanceId")
	proto.RegisterType((*MonitorSet)(nil), "rpc.MonitorSet")
	proto.RegisterType((*Monitor)(nil), "rpc.Monitor")
	proto.RegisterType((*RenewLeaseRequest)(nil), "rpc.RenewLeaseRequest")
	proto.RegisterType((*Lease)(nil), "rpc.Lease")
	proto.RegisterType((*ReportBlockEventsRequest)(nil), "rpc.ReportBlockEventsRequest")
	proto.RegisterType((*ReportBlockEventsRequest_Preflight)(nil), "rpc.ReportBlockEventsRequest.Preflight")
	proto.RegisterType((*Block)(nil), "rpc.Block")
	proto.RegisterType((*BigInt)(nil), "rpc.BigInt")
	proto.RegisterType((*Event)(nil), "rpc.Event")
	proto.RegisterMapType((map[string][]byte)(nil), "rpc.Event.ContextEntry")
}
...
func (c *orchestratorClient) RegisterChainManager(ctx context.Context, in *RegisterChainManagerRequest, opts ...grpc.CallOption) (*RegisterChainManagerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Orchestrator/RegisterChainManager", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orchestratorClient) RenewLease(ctx context.Context, in *RenewLeaseRequest, opts ...grpc.CallOption) (*Lease, error) {
	out := new(Lease)
	err := c.cc.Invoke(ctx, "/rpc.Orchestrator/RenewLease", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orchestratorClient) ReportBlockEvents(ctx context.Context, opts ...grpc.CallOption) (Orchestrator_ReportBlockEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Orchestrator_serviceDesc.Streams[0], "/rpc.Orchestrator/ReportBlockEvents", opts...)
	if err != nil {
		return nil, err
	}
...
func _Orchestrator_RegisterChainManager_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Orchestrator/RegisterChainManager",
	}
...
func _Orchestrator_RenewLease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Orchestrator/RenewLease",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor_96b6e6782baaa298 = []byte{
	...
	,
}
