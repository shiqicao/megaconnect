...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Stmt : kdFire id Expr	<< pa.FireAction(X[1], X[2], pa.TokenToPos(X[0])) >>`,
		Id:         "Stmt",
		NTType:     11,
		Index:      17,
		NumSymbols: 3,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return pa.FireAction(X[1], X[2], pa.TokenToPos(X[0]))
		},
	},
	ProdTabEntry{
	...
	ProdTabEntry{
		String: `Type : kdRat	<< wf.RatType, nil >>`,
		Id:         "Type",
		NTType:     15,
		Index:      27,
		NumSymbols: 1,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return wf.RatType, nil
		},
	},
	ProdTabEntry{
	...
	ProdTabEntry{
		String: `VarDecl : id "=" Expr	<< []interface{}{X[0], X[2]}, nil >>`,
		Id:         "VarDecl",
		NTType:     20,
		Index:      36,
		NumSymbols: 3,
	...
	ProdTabEntry{
		String: `VarDecls : empty	<< wf.IdToExpr{}, nil >>`,
		Id:         "VarDecls",
		NTType:     21,
		Index:      38,
		NumSymbols: 0,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return wf.IdToExpr{}, nil
		},
	},
	ProdTabEntry{
	...
	ProdTabEntry{
		String: `Term4 : "-" Term4	<< pa.UniOpAction(wf.MinusOp, X[1], pa.TokenToPos(X[0])) >>`,
		Id:         "Term4",
		NTType:     26,
		Index:      55,
		NumSymbols: 2,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return pa.UniOpAction(wf.MinusOp, X[1], pa.TokenToPos(X[0]))
		},
	},
	ProdTabEntry{
		String: `Term4 : "!" Term4	<< pa.UniOpAction(wf.NotOp, X[1], pa.TokenToPos(X[0])) >>`,
		Id:         "Term4",
		NTType:     26,
		Index:      56,
		NumSymbols: 2,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return pa.UniOpAction(wf.NotOp, X[1], pa.TokenToPos(X[0]))
		},
	},
	ProdTabEntry{
		String: `Term4 : Term5	<<  >>`,
	...
	ProdTabEntry{
		String: `Term5 : Term5 "." id	<< pa.ObjAccessorAction(X[0], X[2]) >>`,
		Id:         "Term5",
		NTType:     27,
		Index:      58,
		NumSymbols: 3,
	...
	ProdTabEntry{
		String: `Term6 : intLit	<< pa.IntLitAction(X[0]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      60,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Term6 : ratLit	<< pa.RatLitAction(X[0]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      61,
		NumSymbols: 1,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return pa.RatLitAction(X[0])
		},
	},
	ProdTabEntry{
		String: `Term6 : boolLit	<< pa.BoolLitAction(X[0]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      62,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Term6 : stringLit	<< pa.StrLitAction(X[0]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      63,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Term6 : ObjLit	<< pa.ObjLitAction(X[0]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      65,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Term6 : id	<< pa.VarAction(X[0]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      66,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Term6 : kdProps "(" id ")"	<< pa.PropsAction(X[2], X[0], X[3]) >>`,
		Id:         "Term6",
		NTType:     28,
		Index:      68,
		NumSymbols: 4,
