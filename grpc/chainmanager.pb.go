...
// source: grpc/chainmanager.proto
...
func (*SetMonitorsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_97f64146ad2aa6a1, []int{0}
}
...
func (*SetMonitorsRequest_Preflight) Descriptor() ([]byte, []int) {
	return fileDescriptor_97f64146ad2aa6a1, []int{0, 0}
}
...
func (*UpdateMonitorsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_97f64146ad2aa6a1, []int{1}
}
...
func (*UpdateMonitorsRequest_Preflight) Descriptor() ([]byte, []int) {
	return fileDescriptor_97f64146ad2aa6a1, []int{1, 0}
}
...
func (*UpdateMonitorsRequest_AddMonitor) Descriptor() ([]byte, []int) {
	return fileDescriptor_97f64146ad2aa6a1, []int{1, 1}
}
...
func (*UpdateMonitorsRequest_RemoveMonitor) Descriptor() ([]byte, []int) {
	return fileDescriptor_97f64146ad2aa6a1, []int{1, 2}
}
...
func (m *UpdateMonitorsRequest_RemoveMonitor) GetWorkflowId() []byte {
	if m != nil {
		return m.WorkflowId
	}
	return nil
...
func (m *UpdateMonitorsRequest_RemoveMonitor) GetMonitorName() string {
	if m != nil {
...
func init() { proto.RegisterFile("grpc/chainmanager.proto", fileDescriptor_97f64146ad2aa6a1) }

var fileDescriptor_97f64146ad2aa6a1 = []byte{
	// 513 bytes of a gzipped FileDescriptorProto
	,
}
...
var _ChainManager_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/chainmanager.proto",
}
